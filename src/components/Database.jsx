...
function createData(fullNames, calories, bmi, age, weight,height) {
  return {
    fullNames,
    calories,
    bmi,
    ...
    >
      {numSelected > 0 ? (
        ...
        <Typography
          ...
          component="div"
        >
          Health Care,   <p className='text-sm text-orange-300  text-center p-2'>after delete refresh your page....</p>
        </Typography>
...
export default function Database() {
 ...
 React.useEffect(() => {
    ...
    axios.get('https://healthcare-api-p7dm.onrender.com/api/get-bmi')
      .then((response) => {
    ...
    axios.get('https://healthcare-api-p7dm.onrender.com/api/get-calorie')
      .then((response) => {
    ...
    axios.delete(`https://healthcare-api-p7dm.onrender.com/api/delete-bmi/${id}`)
      .then((response) => {
              ...
              {bmiData.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="right">{row.colorie}</TableCell>
